function generate_set(fractal::Function, method::Symbol = :smooth, width::Int = 800, height::Int = 800, x_range=(-2.0, 2.0), y_range=(-2.0, 2.0), max_iter::Int = 100, trap_radius::Float64 = 0.5; kwargs...)
